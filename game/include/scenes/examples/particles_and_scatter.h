...
#pragma region Particles
    ...
    // Particles spawning from one spot instead of being global
    //  Disabling the lifetime would make them spawn once and then disapear once
    //  they exit the areaExtents
    //      instead of spawning continuously
    //      best done with distance fade enabled so they don't blink out of
    //      existence
